...
const NewsLatterBox = () => {
  ...
  return (
    <div className="shadow-three dark:bg-gray-dark relative z-10 rounded-xs bg-white p-8 sm:p-11 lg:p-8 xl:p-11">
      <div>
        <label className="mb-4 block text-lg font-semibold text-dark dark:text-white">
          {t('contact.emailUs')}:{' '}
          <span className="text-primary">{configCompany.email}</span>
        </label>
        <label className="mb-4 block text-lg font-semibold text-dark dark:text-white">
          {t('contact.phoneUs')}:{' '}
          <span className="text-primary">{configCompany.phone}</span>
        </label>
        <label className="mb-4 block text-lg font-semibold text-dark dark:text-white">
          {t('contact.addressUS')}:{' '}
          <span className="text-primary">{i18n.language === "en" ? configCompany.addressEng : configCompany.address}</span>
        </label>
      </div>
